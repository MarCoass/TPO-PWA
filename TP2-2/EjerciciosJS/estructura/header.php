...
<body>
    ...
    <div class="container-fluid ">
        ...
        <nav id="menuHamburguesa" class="navbar navbar-expand-xxxl m-3 ">
            <img src="./estructura/img/World_Taekwondo.png" class="" alt="" width="100px" /><span class="fs-4 ms-3">Poomsae
                Reconocido</span>
            ...
            <div id="navbarNav" class="collapse navbar-collapse ms-3">
                <ul class="navbar-nav" role="tablist">
                    <li class="nav-item" id="seccion1-tab" data-bs-toggle="tab" data-bs-target="#seccion1-pane" role="tab" aria-controls="seccion1-pane" aria-selected="true">
                    ...
                    <li class="nav-item" id="seccion2-tab" data-bs-toggle="tab" data-bs-target="#seccion2-pane" role="tab" aria-controls="seccion2-pane" aria-selected="false">
                    ...
                    <li class="nav-item" id="seccion3-tab" data-bs-toggle="tab" data-bs-target="#seccion3-pane" role="tab" aria-controls="seccion3-pane" aria-selected="false">
                    ...
                    <li class="nav-item" id="seccion4-tab" data-bs-toggle="tab" data-bs-target="#seccion4-pane" role="tab" aria-controls="seccion4-pane" aria-selected="false">
