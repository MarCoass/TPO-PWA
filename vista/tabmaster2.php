<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="miFuncion('fem','master 2 mayor 65')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="miFuncion('masc','master 2 mayor 65')">Masculino</button>
        <hr>
        <h4>Master 2</h4>
        <p>
