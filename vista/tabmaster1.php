<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="btnCambioGen('fem','master 1 menos 65')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="btnCambioGen('masc','master 1 menos 65')">Masculino</button>
        <hr>
        <h4>Master 1</h4>
        <p>
...
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Julian Serrano es el ganador de Poomsae Elite Individual en la categoría Master 1. 
...
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Romina Gonzales es la ganadora de la categoría Master 1 en la última competencia. 
