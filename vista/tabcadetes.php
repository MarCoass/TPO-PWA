<div class="row">
    ...
    <div class="col-lg-8 col-sm-8 " style="--bs-bg-opacity: .50;">
        <img id="imagen cadete 12-14" src="./Assets/Img/img/cadete 12-14 f.jpg" alt="" class="img-fluid rounded" id="imagenExpandida">
    </div>
</div>
<hr>
<div id="infoMasccadete 12-14" class="row d-none">
...
<div id="infoFemcadete 12-14" class="row">
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
        <table class="table text-center m-auto bg-light rounded">
            <thead>
                <tr>
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Romina Gonzales es la ganadora de la categoría Cadetes en la última competencia. 
