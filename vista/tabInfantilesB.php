<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="btnCambioGen('fem','infantiles b')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="btnCambioGen('masc','infantiles b')">Masculino</button>
        <hr>
        <h4>Infantil B</h4>
        <p>
            En la competencia de poomsae reconocido elite, los competidores demostraron sus habilidades en el taekwondo 
            con movimientos precisos y potentes. Los jueces evaluaron la técnica y la precisión, y los fanáticos apoyaron 
            con entusiasmo. Después de muchas rondas, un ganador fue coronado, celebrando su increíble habilidad y dedicación.
        </p>
    </div>
    ...
    <div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
        <table class="table text-center m-auto bg-light rounded">
            ...
            <tbody class="table-group-divider">
                <tr>
                    <th scope="row"  class="d-none d-sm-table-cell">183</th>
                    <th class="d-none d-sm-table-cell">Neuquén</th>
                ...
                <tr>
                    <th scope="row"  class="d-none d-sm-table-cell">342</th>
                    <th class="d-none d-sm-table-cell">Tucumán</th>
                ...
                <tr>
                    <th scope="row"  class="d-none d-sm-table-cell">57</th>
                    <th class="d-none d-sm-table-cell">Formosa</th>
                    <td>Pepe Argento</td>
                    <th>4,5</th>
                    <th class="position-relative"><span class="position-absolute top-50 start-75 translate-middle badge bg-danger">3° Lugar</span></th>
                </tr>
                <tr>
                    <th scope="row"  class="d-none d-sm-table-cell">129</th>
                    <th class="d-none d-sm-table-cell">Jujuy</th>
...
<div id="infoFeminfantiles b" class="row">
        ...
        <table class="table text-center m-auto bg-light rounded">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell">Buenos Aires</th>
                    <td>Lucía Sánchez</td>
                    <th class="">6.57</th>
                    <th class="position-relative"><span class="position-absolute top-50 start-75 translate-middle badge bg-danger">3° Lugar</span></th>
                </tr>
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell">Santa Fe</th>
                    <td>Agustina Fernández</td>
                    <th class="">6.02</th>
                </tr>
            </tbody>
        </table>
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Romina Gonzales es la ganadora de la categoría Infantiles B en la última competencia. 
