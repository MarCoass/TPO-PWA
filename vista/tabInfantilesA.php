...
<hr>
<div class="row">
    <div class="col-lg-8 col-sm-8 p-3 table-responsive" style="--bs-bg-opacity: .75;" id="tabla">
        <table id="tabla" class="table text-center m-auto bg-light rounded tablaResultado">
            <thead>
                <tr>
            ...
            <tbody class="table-group-divider">
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell">5,13</th>
                ...
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell">4,89</th>
                ...
                <tr>
                    ...
                    <td>Pepe Argento</td>
                    <th class="d-none d-sm-table-cell">4,5</th>
                ...
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell">4,17</th>
                </tr>
            </tbody>
        </table>
    </div>
