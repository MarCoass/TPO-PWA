<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="btnCambioGen('fem','infantiles a')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="btnCambioGen('masc','infantiles a')">Masculino</button>
        <hr>
        <h4>Infantil A</h4>
        <p>
...
<div id="infoMascinfantiles a" class="row d-none">
...
<div id="infoFeminfantiles a" class="row">
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
        <table class="table text-center m-auto bg-light rounded">
            <thead>
                <tr>
