                ...
                <div class="carousel-item active " data-bs-interval="2000">
                    <div class="d-flex justify-content-center">
                        <div class="nav-link" data-bs-toggle="tab" data-bs-target="#infantilB">
                            <img src="./Assets/Img/thumbnails/infantiles b.jpg" class="rounded-circle" alt="..." height="100px" />
                ...
                <div class="carousel-item" data-bs-interval="2000">
                    <div class="d-flex justify-content-center">
                        <div class="nav-link" data-bs-toggle="tab" data-bs-target="#infantilA">
                            <img src="./Assets/Img/thumbnails/infantiles a.jpg" class="rounded-circle" alt="..." height="100px" />
                            <div class="pe-none carousel-caption">
                                <h5>Infantiles A</h5>
                            </div>
                        </div>
                ...
                <div class="carousel-item" data-bs-interval="2000">
                    <div class="d-flex justify-content-center">
                        <div class="nav-link" data-bs-toggle="tab" data-bs-target="#cadete">
                            <img src="./Assets/Img/thumbnails/cadete 12-14.jpg" class="rounded-circle" alt="..." height="100px" />
                        </div>
                    </div>
