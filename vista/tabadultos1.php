<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="miFuncion('fem','adulto 1 menos 30')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="miFuncion('masc','adulto 1 menos 30')">Masculino</button>
        <hr>
        <h4>Adultos 1</h4>
        <p>
