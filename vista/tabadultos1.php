<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="btnCambioGen('fem','adulto 1 menos 30')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="btnCambioGen('masc','adulto 1 menos 30')">Masculino</button>
        <hr>
        <h4>Adultos 1</h4>
        <p>
    ...
    <div class="col-lg-8 col-sm-8 " style="--bs-bg-opacity: .50;">
        <img id="imagen adulto 1 menos 30" src="./Assets/Img/img/adulto 1 menos 30 f.jpg" alt="" class="img-fluid rounded" id="imagenExpandida">
    </div>
</div>
<hr>
<div id="infoMascadulto 1 menos 30" class="row d-none">
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Julian Serrano es el ganador de Poomsae Elite Individual en la categoría Adultos 1. 
...
<div id="infoFemadulto 1 menos 30" class="row">
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
        <table class="table text-center m-auto bg-light rounded">
            <thead>
                <tr>
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Romina Perez es la ganadora de la categoría Adulto 1 en la última competencia. 
