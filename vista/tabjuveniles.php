<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="btnCambioGen('fem','juveniles 15-17')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="btnCambioGen('masc','juveniles 15-17')">Masculino</button>
        <hr>
        <h4>Juveniles</h4>
        <p>
    ...
    <div class="col-lg-8 col-sm-8 " style="--bs-bg-opacity: .50;">
        <img id="imagen juveniles 15-17" src="./Assets/Img/img/juveniles 15-17 f.jpg" alt="" class="img-fluid rounded" id="imagenExpandida">
    </div>
</div>
<hr>
<div id="infoMascjuveniles 15-17" class="row d-none">
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Julian Serrano es el ganador de Poomsae Elite Individual en la categoría Juveniles. 
...
<div id="infoFemjuveniles 15-17" class="row">
<div class="col-lg-8 col-sm-8 p-3 table-responsive-sm">
        <table class="table text-center m-auto bg-light rounded">
            <thead>
                <tr>
    ...
    <div class="col-lg-4 col-sm-4 p-3" id="parrafo">
        Romina Gonzales es la ganadora de la categoría Juveniles en la última competencia. 
