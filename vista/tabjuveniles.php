<div class="row">
    <div class="col-lg-4 col-sm-4 p-3">
        <button class="btn btn-secondary" id="fem" onclick="miFuncion('fem','juveniles 15-17')">Femenino</button>
        <button class="btn btn-secondary" id="masc" onclick="miFuncion('masc','juveniles 15-17')">Masculino</button>
        <hr>
        <h4>Juveniles</h4>
        <p>
