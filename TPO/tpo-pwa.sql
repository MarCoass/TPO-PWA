...
-- Volcando estructura de base de datos para tpo-pwa
CREATE DATABASE IF NOT EXISTS `tpo-pwa` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tpo-pwa`;

-- Volcando estructura para tabla tpo-pwa.competidores
CREATE TABLE IF NOT EXISTS `competidores` (
  `du` int unsigned NOT NULL,
  `legajo` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `apellido` varchar(50) NOT NULL,
  `nombre` varchar(50) NOT NULL,
  `fechaNacimiento` date NOT NULL,
  `paisOrigen` varchar(2) NOT NULL,
  `estadoOrigen` int NOT NULL,
  `graduacion` varchar(20) NOT NULL,
  `rankingNacional` float(1,1) unsigned NOT NULL,
  `email` varchar(100) NOT NULL,
  `genero` varchar(20) NOT NULL,
  PRIMARY KEY (`du`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla tpo-pwa.competidores: ~50 rows (aproximadamente)
DELETE FROM `competidores`;
INSERT INTO `competidores` (`du`, `legajo`, `apellido`, `nombre`, `fechaNacimiento`, `paisOrigen`, `estadoOrigen`, `graduacion`, `rankingNacional`, `email`, `genero`) VALUES
	(1052918, 'TKW5248336', 'Aldins', 'Kally', '1963-11-18', '15', 5, '10mo Dan', 0.9, 'kaldinsa@joomla.org', 'Femenino'),
	(1350397, 'TKW3324439', 'Akram', 'Zabrina', '1979-08-19', '15', 2, '2do Dan', 0.9, 'zakramc@unc.edu', 'Masculino'),
	(2472789, 'TKW6950966', 'Stripp', 'Julius', '1958-02-23', '68', 1, '8vo Dan', 0.9, 'jstripp6@homestead.com', 'Femenino'),
	(3752466, 'TKW6682865', 'Skelhorn', 'Vania', '1987-02-20', '88', 5, '5to Dan', 0.9, 'vskelhorn19@creativecommons.org', 'Femenino'),
	(5664883, 'TKW2927049', 'Hounson', 'Bryanty', '1971-04-20', '10', 5, '8vo Dan', 0.9, 'bhounsonh@wunderground.com', 'Masculino'),
	(6942128, 'TKW8458448', 'Heed', 'Davita', '2012-05-08', '95', 3, '8vo Dan', 0.9, 'dheedj@nbcnews.com', 'Femenino'),
	(10911266, 'TKW8399008', 'Pastor', 'Sayre', '1977-08-10', '20', 2, '7mo Dan', 0.9, 'spastor3@sciencedirect.com', 'Masculino'),
	(11369807, 'TKW7548247', 'Bomfield', 'Suzi', '1994-10-10', '12', 2, '9no Dan', 0.9, 'sbomfieldo@skyrock.com', 'Femenino'),
	(12685938, 'TKW8806818', 'Grist', 'Nonna', '1995-11-16', '10', 2, '5to Dan', 0.9, 'ngristk@cnet.com', 'Masculino'),
	(14483370, 'TKW7835309', 'Andrini', 'Powell', '1980-06-22', '86', 5, '7mo Dan', 0.9, 'pandrini4@so-net.ne.jp', 'Femenino'),
	(14798402, 'TKW5795859', 'Dowbekin', 'Emmery', '1966-11-23', '23', 4, '9no Dan', 0.9, 'edowbekine@ted.com', 'Masculino'),
	(14929766, 'TKW2857353', 'Nelthorpe', 'Ellen', '1975-10-09', '17', 5, '2do Dan', 0.9, 'enelthorpe8@umn.edu', 'Femenino'),
	(15053710, 'TKW4266969', 'Chiverstone', 'Sofia', '1982-10-24', '17', 5, '1er Dan', 0.9, 'schiverstone1c@bigcartel.com', 'Masculino'),
	(22220115, 'TKW0504856', 'Waylett', 'Archie', '1953-10-26', '20', 5, '4to Dan', 0.9, 'awaylettw@netscape.com', 'Masculino'),
	(24965402, 'TKW8868544', 'Common', 'Shae', '1964-03-03', '63', 1, '3er Dan', 0.9, 'scommon5@salon.com', 'Femenino'),
	(25532088, 'TKW2465468', 'Garard', 'Lynnett', '1976-01-07', '14', 5, '2do Dan', 0.9, 'lgarard1@mayoclinic.com', 'Femenino'),
	(34423051, 'TKW7794112', 'Hansley', 'Liva', '2012-02-25', '24', 4, '6to Dan', 0.9, 'lhansley7@wordpress.com', 'Masculino'),
	(34771654, 'TKW1363754', 'Mallam', 'Luke', '1945-11-30', '50', 3, '3er Dan', 0.9, 'lmallam16@freewebs.com', 'Masculino'),
	(35261513, 'TKW8731683', 'McLagan', 'Hilarius', '2011-08-19', '23', 3, '8vo Dan', 0.9, 'hmclagan14@behance.net', 'Masculino'),
	(35558263, 'TKW2212482', 'Canedo', 'Christiana', '1987-09-25', '23', 2, '3er Dan', 0.9, 'ccanedoz@eventbrite.com', 'Masculino'),
	(36970883, 'TKW1530212', 'McKeever', 'Dulsea', '1968-04-01', '87', 2, '4to Dan', 0.9, 'dmckeeverr@a8.net', 'Femenino'),
	(41694540, 'TKW6362814', 'Tingle', 'Claudianus', '1996-02-19', '14', 3, '1er Dan', 0.9, 'ctingle11@storify.com', 'Femenino'),
	(42370967, 'TKW2064206', 'Ragdale', 'Rubina', '1969-07-04', '48', 4, '6to Dan', 0.9, 'rragdales@cocolog-nifty.com', 'Femenino'),
	(42693560, 'TKW3933270', 'Barraclough', 'Simona', '1978-05-01', '20', 1, '8vo Dan', 0.9, 'sbarraclough2@nba.com', 'Masculino'),
	(46492411, 'TKW8877244', 'Wilks', 'Natassia', '1954-06-04', '23', 3, '10mo Dan', 0.9, 'nwilksb@furl.net', 'Masculino'),
	(46687895, 'TKW0388313', 'Bartell', 'Killian', '1940-11-14', '13', 1, '7mo Dan', 0.9, 'kbartellx@eepurl.com', 'Masculino'),
	(46952180, 'TKW3883157', 'Adamoli', 'Belle', '1984-03-15', '51', 2, '5to Dan', 0.9, 'badamolim@guardian.co.uk', 'Masculino'),
	(48838145, 'TKW8242005', 'Davisson', 'Desmond', '1958-11-03', '19', 2, '9no Dan', 0.9, 'ddavissonn@stanford.edu', 'Masculino'),
	(49104578, 'TKW9055601', 'Henfre', 'Marisa', '1951-06-19', '25', 3, '5to Dan', 0.9, 'mhenfre15@sbwire.com', 'Masculino'),
	(51625603, 'TKW4286564', 'Bestiman', 'Bethany', '1965-01-16', '13', 5, '6to Dan', 0.9, 'bbestimanu@buzzfeed.com', 'Masculino'),
	(55153864, 'TKW4802962', 'Maisey', 'Allyce', '1952-12-21', '14', 4, '2do Dan', 0.9, 'amaisey17@sourceforge.net', 'Femenino'),
	(56764868, 'TKW9105292', 'Sore', 'Aura', '1986-04-14', '10', 2, '3er Dan', 0.9, 'asore1d@ca.gov', 'Masculino'),
	(58596339, 'TKW3727156', 'Endean', 'Jennica', '1947-06-08', '15', 2, '5to Dan', 0.9, 'jendean9@cnbc.com', 'Masculino'),
	(59809480, 'TKW3422286', 'Ruos', 'Madlin', '1981-03-25', '32', 1, '8vo Dan', 0.9, 'mruos13@home.pl', 'Masculino'),
	(67269116, 'TKW6720905', 'Kellard', 'Norma', '1980-07-22', '96', 5, '7mo Dan', 0.9, 'nkellard1a@intel.com', 'Masculino'),
	(69584029, 'TKW5267649', 'Aslie', 'Jervis', '1959-06-22', '11', 2, '2do Dan', 0.9, 'jaslie1b@admin.ch', 'Masculino'),
	(72146388, 'TKW5306036', 'Daunter', 'Drona', '1985-11-12', '14', 5, '6to Dan', 0.9, 'ddaunteri@weebly.com', 'Femenino'),
	(75721964, 'TKW6712964', 'Lillgard', 'Ava', '1993-02-05', '73', 2, '4to Dan', 0.9, 'alillgardg@smugmug.com', 'Femenino'),
	(76429742, 'TKW9490482', 'Yeaman', 'Amandy', '2002-07-06', '12', 1, '4to Dan', 0.9, 'ayeaman18@spotify.com', 'Masculino'),
	(78635910, 'TKW4641175', 'Durgan', 'Town', '1986-06-02', '14', 2, '9no Dan', 0.9, 'tdurgant@liveinternet.ru', 'Femenino'),
	(82183817, 'TKW4473964', 'Skeleton', 'Jaquenette', '1991-02-22', '13', 2, '5to Dan', 0.9, 'jskeleton12@opensource.org', 'Femenino'),
	(84642001, 'TKW0312096', 'Yarnton', 'Janey', '2010-10-27', '14', 4, '10mo Dan', 0.9, 'jyarntonf@mapquest.com', 'Masculino'),
	(87964960, 'TKW5524442', 'McCullough', 'Gar', '1980-04-25', '22', 5, '8vo Dan', 0.9, 'gmcculloughd@barnesandnoble.com', 'Femenino'),
	(89111176, 'TKW5371834', 'Phinnis', 'Kikelia', '1971-11-30', '12', 1, '7mo Dan', 0.9, 'kphinnis10@ameblo.jp', 'Masculino'),
	(90534004, 'TKW5942468', 'Lethbury', 'Addia', '1982-11-08', '24', 5, '8vo Dan', 0.9, 'alethburyq@abc.net.au', 'Femenino'),
	(90872698, 'TKW8804667', 'Ashmore', 'Viviana', '2000-01-18', '10', 4, '10mo Dan', 0.9, 'vashmore0@pinterest.com', 'Femenino'),
	(90920388, 'TKW6279750', 'Troctor', 'Bryana', '1953-09-20', '16', 5, '7mo Dan', 0.9, 'btroctorl@zimbio.com', 'Masculino'),
	(91124464, 'TKW3713558', 'VanBrugh', 'Mellicent', '1982-04-17', '15', 1, '2do Dan', 0.9, 'mvanbrughp@economist.com', 'Masculino'),
	(94983493, 'TKW5144220', 'Sitford', 'Cher', '1954-02-21', '15', 4, '1er Dan', 0.9, 'csitfordv@ibm.com', 'Masculino'),
	(96432985, 'TKW3395868', 'Brumpton', 'Gardener', '1972-01-24', '23', 4, '7mo Dan', 0.9, 'gbrumptony@bluehost.com', 'Masculino');

-- Volcando estructura para tabla tpo-pwa.estado
CREATE TABLE IF NOT EXISTS `estado` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ubicacionpaisid` int DEFAULT NULL,
  `estadonombre` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4786469191104EC2` (`ubicacionpaisid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

-- Volcando datos para la tabla tpo-pwa.estado: ~0 rows (aproximadamente)
DELETE FROM `estado`;
...
-- Volcando estructura para tabla tpo-pwa.pais
CREATE TABLE IF NOT EXISTS `pais` (
  `id` int NOT NULL AUTO_INCREMENT,
  `paisnombre` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=247 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

-- Volcando datos para la tabla tpo-pwa.pais: ~214 rows (aproximadamente)
DELETE FROM `pais`;
