...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2023 a las 22:23:36
...
CREATE TABLE `competidores` (
  `du` int(10) UNSIGNED NOT NULL,
  `legajo` varchar(10) NOT NULL,
  `apellido` varchar(50) NOT NULL,
  `nombre` varchar(50) NOT NULL,
  `fechaNacimiento` date NOT NULL,
  `estadoOrigen` int(11) NOT NULL,
  `graduacion` varchar(20) NOT NULL,
  `rankingNacional` float(5,2) UNSIGNED NOT NULL,
...
INSERT INTO `competidores` (`du`, `legajo`, `apellido`, `nombre`, `fechaNacimiento`, `estadoOrigen`, `graduacion`, `rankingNacional`, `email`, `genero`) VALUES
(1052918, 'TKW5248336', 'Aldins', 'Kally', '1963-11-18', 164, '10mo Dan', 857.64, 'kaldinsa@joomla.org', 'Femenino'),
(1350397, 'TKW3324439', 'Akram', 'Zabrina', '1979-08-19', 125, '2do Dan', 414.18, 'zakramc@unc.edu', 'Masculino'),
(2472789, 'TKW6950966', 'Stripp', 'Julius', '1958-02-23', 284, '8vo Dan', 616.0, 'jstripp6@homestead.com', 'Femenino'),
(3752466, 'TKW6682865', 'Skelhorn', 'Vania', '1987-02-20', 260, '5to Dan', 722.32, 'vskelhorn19@creativecommons.org', 'Femenino'),
(5664883, 'TKW2927049', 'Hounson', 'Bryanty', '1971-04-20', 52, '8vo Dan', 9.37, 'bhounsonh@wunderground.com', 'Masculino'),
(6942128, 'TKW8458448', 'Heed', 'Davita', '2012-05-08', 83, '8vo Dan', 116.56, 'dheedj@nbcnews.com', 'Femenino'),
(10911266, 'TKW8399008', 'Pastor', 'Sayre', '1977-08-10', 179, '7mo Dan', 587.82, 'spastor3@sciencedirect.com', 'Masculino'),
(11369807, 'TKW7548247', 'Bomfield', 'Suzi', '1994-10-10', 277, '9no Dan', 534.53, 'sbomfieldo@skyrock.com', 'Femenino'),
(12685938, 'TKW8806818', 'Grist', 'Nonna', '1995-11-16', 255, '5to Dan', 248.07, 'ngristk@cnet.com', 'Masculino'),
(14483370, 'TKW7835309', 'Andrini', 'Powell', '1980-06-22', 197, '7mo Dan', 207.52, 'pandrini4@so-net.ne.jp', 'Femenino'),
(14798402, 'TKW5795859', 'Dowbekin', 'Emmery', '1966-11-23', 9, '9no Dan', 444.69, 'edowbekine@ted.com', 'Masculino'),
(14929766, 'TKW2857353', 'Nelthorpe', 'Ellen', '1975-10-09', 186, '2do Dan', 778.11, 'enelthorpe8@umn.edu', 'Femenino'),
(15053710, 'TKW4266969', 'Chiverstone', 'Sofia', '1982-10-24', 80, '1er Dan', 632.93, 'schiverstone1c@bigcartel.com', 'Masculino'),
(22220115, 'TKW0504856', 'Waylett', 'Archie', '1953-10-26', 78, '4to Dan', 296.03, 'awaylettw@netscape.com', 'Masculino'),
(24965402, 'TKW8868544', 'Common', 'Shae', '1964-03-03', 250, '3er Dan', 509.67, 'scommon5@salon.com', 'Femenino'),
(25532088, 'TKW2465468', 'Garard', 'Lynnett', '1976-01-07', 190, '2do Dan', 498.7, 'lgarard1@mayoclinic.com', 'Femenino'),
(34423051, 'TKW7794112', 'Hansley', 'Liva', '2012-02-25', 17, '6to Dan', 212.90, 'lhansley7@wordpress.com', 'Masculino'),
(34771654, 'TKW1363754', 'Mallam', 'Luke', '1945-11-30', 115, '3er Dan', 531.35, 'lmallam16@freewebs.com', 'Masculino'),
(35261513, 'TKW8731683', 'McLagan', 'Hilarius', '2011-08-19', 243, '8vo Dan', 509.74, 'hmclagan14@behance.net', 'Masculino'),
(35558263, 'TKW2212482', 'Canedo', 'Christiana', '1987-09-25', 56, '3er Dan', 227.93, 'ccanedoz@eventbrite.com', 'Masculino'),
(36970883, 'TKW1530212', 'McKeever', 'Dulsea', '1968-04-01', 208, '4to Dan', 879.94, 'dmckeeverr@a8.net', 'Femenino'),
(41694540, 'TKW6362814', 'Tingle', 'Claudianus', '1996-02-19', 164, '1er Dan', 115.72, 'ctingle11@storify.com', 'Femenino'),
(42370967, 'TKW2064206', 'Ragdale', 'Rubina', '1969-07-04', 184, '6to Dan', 306.86, 'rragdales@cocolog-nifty.com', 'Femenino'),
(42693560, 'TKW3933270', 'Barraclough', 'Simona', '1978-05-01', 155, '8vo Dan', 73.5, 'sbarraclough2@nba.com', 'Masculino'),
(46492411, 'TKW8877244', 'Wilks', 'Natassia', '1954-06-04', 183, '10mo Dan', 646.04, 'nwilksb@furl.net', 'Masculino'),
(46687895, 'TKW0388313', 'Bartell', 'Killian', '1940-11-14', 162, '7mo Dan', 631.60, 'kbartellx@eepurl.com', 'Masculino'),
(46952180, 'TKW3883157', 'Adamoli', 'Belle', '1984-03-15', 219, '5to Dan', 333.4, 'badamolim@guardian.co.uk', 'Masculino'),
(48838145, 'TKW8242005', 'Davisson', 'Desmond', '1958-11-03', 266, '9no Dan', 188.89, 'ddavissonn@stanford.edu', 'Masculino'),
(49104578, 'TKW9055601', 'Henfre', 'Marisa', '1951-06-19', 143, '5to Dan', 736.72, 'mhenfre15@sbwire.com', 'Masculino'),
(51625603, 'TKW4286564', 'Bestiman', 'Bethany', '1965-01-16', 126, '6to Dan', 683.75, 'bbestimanu@buzzfeed.com', 'Masculino'),
(55153864, 'TKW4802962', 'Maisey', 'Allyce', '1952-12-21', 15, '2do Dan', 798.29, 'amaisey17@sourceforge.net', 'Femenino'),
(56764868, 'TKW9105292', 'Sore', 'Aura', '1986-04-14', 169, '3er Dan', 50.1, 'asore1d@ca.gov', 'Masculino'),
(58596339, 'TKW3727156', 'Endean', 'Jennica', '1947-06-08', 27, '5to Dan', 780.64, 'jendean9@cnbc.com', 'Masculino'),
(59809480, 'TKW3422286', 'Ruos', 'Madlin', '1981-03-25', 277, '8vo Dan', 438.1, 'mruos13@home.pl', 'Masculino'),
(67269116, 'TKW6720905', 'Kellard', 'Norma', '1980-07-22', 145, '7mo Dan', 96.07, 'nkellard1a@intel.com', 'Masculino'),
(69584029, 'TKW5267649', 'Aslie', 'Jervis', '1959-06-22', 272, '2do Dan', 436.54, 'jaslie1b@admin.ch', 'Masculino'),
(72146388, 'TKW5306036', 'Daunter', 'Drona', '1985-11-12', 126, '6to Dan', 505.13, 'ddaunteri@weebly.com', 'Femenino'),
(75721964, 'TKW6712964', 'Lillgard', 'Ava', '1993-02-05', 58, '4to Dan', 507.38, 'alillgardg@smugmug.com', 'Femenino'),
(76429742, 'TKW9490482', 'Yeaman', 'Amandy', '2002-07-06', 105, '4to Dan', 135.47, 'ayeaman18@spotify.com', 'Masculino'),
(78635910, 'TKW4641175', 'Durgan', 'Town', '1986-06-02', 82, '9no Dan', 28.44, 'tdurgant@liveinternet.ru', 'Femenino'),
(82183817, 'TKW4473964', 'Skeleton', 'Jaquenette', '1991-02-22', 257, '5to Dan', 371.78, 'jskeleton12@opensource.org', 'Femenino'),
(84642001, 'TKW0312096', 'Yarnton', 'Janey', '2010-10-27', 33, '10mo Dan', 272.01, 'jyarntonf@mapquest.com', 'Masculino'),
(87964960, 'TKW5524442', 'McCullough', 'Gar', '1980-04-25', 133, '8vo Dan', 17., 'gmcculloughd@barnesandnoble.com', 'Femenino'),
(89111176, 'TKW5371834', 'Phinnis', 'Kikelia', '1971-11-30', 135, '7mo Dan', 702.86, 'kphinnis10@ameblo.jp', 'Masculino'),
(90534004, 'TKW5942468', 'Lethbury', 'Addia', '1982-11-08', 179, '8vo Dan', 326.41, 'alethburyq@abc.net.au', 'Femenino'),
(90872698, 'TKW8804667', 'Ashmore', 'Viviana', '2000-01-18', 79, '10mo Dan', 715.08, 'vashmore0@pinterest.com', 'Femenino'),
(90920388, 'TKW6279750', 'Troctor', 'Bryana', '1953-09-20', 187, '7mo Dan', 503.80, 'btroctorl@zimbio.com', 'Masculino'),
(91124464, 'TKW3713558', 'VanBrugh', 'Mellicent', '1982-04-17', 280, '2do Dan', 516.94, 'mvanbrughp@economist.com', 'Masculino'),
(94983493, 'TKW5144220', 'Sitford', 'Cher', '1954-02-21', 178, '1er Dan', 216.43, 'csitfordv@ibm.com', 'Masculino'),
(96432985, 'TKW3395868', 'Brumpton', 'Gardener', '1972-01-24', 172, '7mo Dan', 325.51, 'gbrumptony@bluehost.com', 'Masculino');
...
ALTER TABLE `competidores`
  ADD PRIMARY KEY (`du`),
  ADD KEY `estadoOrigen` (`estadoOrigen`);
...
--
ALTER TABLE `competidores`
  ADD CONSTRAINT `competidores_ibfk_1` FOREIGN KEY (`estadoOrigen`) REFERENCES `estado` (`id`);

--
-- Filtros para la tabla `estado`
--
ALTER TABLE `estado`
  ADD CONSTRAINT `estado_ibfk_1` FOREIGN KEY (`ubicacionpaisid`) REFERENCES `pais` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
