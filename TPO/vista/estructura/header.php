    ...
    <header class="sticky-top border-bottom border-danger border-2">
        <div>
            <nav id="menuHamburguesa" class="navbar navbar-expand-xxxl p-3  text-bg-light">
                ...
                <img src="../util/Img/World_Taekwondo.png" alt="logo TKD" width="100px" /><span class="fs-4 ms-3 tituloPag">Poomsae
                    Reconocido</span>
                ...
                <div id="navbarNav" class="collapse navbar-collapse ms-3">
                    <ul class="navbar-nav" role="tablist">
                        <a href="#seccion1" class="nav-item active btn" id="seccion1-tab">
                        ...
                        <a href="#seccion2" class="nav-item btn" id="seccion2-tab">
                        ...
                        <a href="#seccion3" class="nav-item btn" id="seccion3-tab">
                        ...
                        <a href="#seccion3" class="nav-item btn" id="seccion4-tab" data-bs-toggle="modal" data-bs-target="#modalFormCompetidor">
                        ...
                        <a href="#seccion4" class="nav-item btn" id="seccion5-tab">
