...
<body>
    ...
    <div class="container-fluid ">
        <nav class="navbar navbar-expand-lg m-3">
            <div class="container-fluid">
                <img src="../util/img/World_Taekwondo.png" alt="" width="100px" /><span class="fs-4 ms-3">Poomsae Reconocido</span>
                ...
                <div class="collapse navbar-collapse ms-3" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="./agregarCompetidor.php">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="./tablaCompetidores.php">
