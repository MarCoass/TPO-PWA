...
<head>
    ...
    <!-- ICON -->
    <link rel="icon" type="image\x-icon" href=".\estructura\logo.ico">
...
<body>
    ...
    <div class="container-fluid ">
        <nav class="navbar navbar-expand-lg m-3">
            <div class="container-fluid">
                <img src="./estructura/World_Taekwondo.png" alt="" width="100px" /><span class="fs-4 ms-3">Poomsae Reconocido</span>
                ...
                <div class="collapse navbar-collapse ms-3" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="tablaRegistro.php">
