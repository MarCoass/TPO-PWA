...
<div class="row col-10 mx-auto my-5 shadow" style="min-height: 400px;">
    ...
    <div class="col-8 position-relative">
        <div class="nav justify-content-center">
            <div class="nav-link active" data-bs-toggle="tab" data-bs-target="#paso1">
            ...
            <div class="nav-link" data-bs-toggle="tab" data-bs-target="#paso2">
        ...
        <form id="myForm"> <!-- INICIO FORM -->
            <div class="tab-content">
                <div class="tab-pane fade show active" id="paso1" role="tabpanel" aria-labelledby="paso1-tab"> <!-- INICIO CONTENIDO PASO 1 -->
                    <div class="row">
                ...
                <div class="tab-pane fade" id="paso2" role="tabpanel" aria-labelledby="paso2-tab"> <!-- INICIO CONTENIDO PASO 2 -->
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12  pt-3">
