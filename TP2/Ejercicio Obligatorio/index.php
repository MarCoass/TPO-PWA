                ...
                <div class="tab-pane fade show active" id="paso1"> <!-- INICIO CONTENIDO PASO 1 -->
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12  pt-3">
                            ...
                            <input class="form-control" type="text" id="apellido" name="apellido"  maxlength="50" placeholder="Ej: Lopez" autocomplete="off"
                                required>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12  pt-3">
                            ...
                            <input class="form-control" type="text" id="nombre" name="nombre" maxlength="50" placeholder="Ej: Lautaro" autocomplete="off"
                                required>
                            <div class="valid-feedback">
                                ¡Correcto!
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12  pt-3">
                            ...
                            <input class="form-control" type="email" id="email" name="email" autocomplete="off"
                                pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Ej: persona@correo.com" required>
                            <div class="valid-feedback">
                                ¡Correcto!
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12  pt-3">
                            ...
                            <select class="form-control" id="genero" name="genero" required>
                                <option disabled selected data-error="Por favor seleccione un genero">Selecciona una opción</option>
                        ...
                        <div class="my-3 ml-3 row justify-content-center">
                            <button type="button" class="btn btn-outline-primary  col-md-4 col-sm-6"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12  pt-3">
                            ...
                            <input class="form-control" type="text" id="legajo" name="legajo" autocomplete="off"
                                pattern="^[a-zA-Z]{3}[0-9]{7}$" placeholder="Ej: ABC1234567" required>
                            <div class="valid-feedback">
                                ¡Correcto!
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12  pt-3">
                            ...
                            <div class="invalid-feedback">Mandate un numero</div>
                        </div>
                        ...
                        <div class="my-3 ml-3 row justify-content-center">
                            <button type="button" class="btn btn-outline-secondary col-md-4 col-sm-6"
