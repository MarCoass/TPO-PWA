...
@section('contenido')
    <form class="m-5 row" method="post" action="{{ route('permisos.store')}} ">
        ...
        <div class="col-lg-6 col-12 form-group form-floating mb-3">
            <input type="text" class="form-control" name="nombrePermiso" id="nombrePermiso" placeholder="nombre"
        ...
        <div class="col-lg-6 col-12 form-group form-floating mb-3">
            <input type="text" class="form-control" name="rutaPermiso" id="rutaPermiso" placeholder="ruta"
                required="required">
        ...
        <div class="col-lg-6 col-12 form-group mb-3">
            ...
            @foreach($roles as $rol)
                    <input type="checkbox" class="form-check-input roles" name="roles[]" value="{{ $rol->id }}"> 
