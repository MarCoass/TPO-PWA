...
@section('contenido')
    <form class="m-5 row" method="post" action="{{ route('store_competencia') }}">
        ...
        <div class="col-lg-6 col-12 form-group form-floating mb-3">
            <input type="date" class="form-control" name="fecha" value="{{ old('fecha') }}" placeholder="fecha" required="required" autofocus>
