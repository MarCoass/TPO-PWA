<div class="modal fade text-dark" id="modalImagen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>URL: <a href="#" id="urlImagen" target="_blank"></a></p>
            </div>
