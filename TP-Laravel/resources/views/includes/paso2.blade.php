<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  pt-3">
    ...
    <input class="form-control validarEspecial" disabled type="text" id="gal" name="gal" autocomplete="off" pattern="^[A-Z]{3}\d{7}$" maxlength="10" placeholder="Ej: ABC1234567" required>
