<div class="row">
    <div class="col-lg-4 col-md-12 p-3">
        ...
        <button class="btn btn-outline-primary" id="masc" onclick="btnCambioGen('masc')">Masculino</button>
    </div>
...
<div id="infoFem" class="row">
    ...
    <div class="col-lg-4 col-sm-4 p-3">
        <!-- CARD DEL GANADOR -->
        <div id="cardGanadorFemenino" class='card position-relative shadow mx-auto' style='min-height: 350px; width: 300px'>
        </div>
    </div>
</div>
...
<div id="infoMasc" class="row d-none">
    ...
    <div class="col-lg-4 col-sm-4 p-3">
        <!-- CARD DEL GANADOR -->
        <div id="cardGanadorMasculino" class='card position-relative shadow mx-auto' style='min-height: 350px; width: 300px'>
        </div>
    </div>
</div>